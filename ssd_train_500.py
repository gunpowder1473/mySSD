...
tf.app.flags.DEFINE_string(
    'dataset_dir', "C://SSD/PicData/", 'The directory where the dataset files are stored.')
tf.app.flags.DEFINE_integer(
    'labels_offset', 0,
...
tf.app.flags.DEFINE_string(
    'model_name', 'ssd_512', 'The name of the architecture to train.')
tf.app.flags.DEFINE_string(
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        ssd_params = ssd_network.SSDNet_512.default_params._replace(num_classes=FLAGS.num_classes)
        ssd_net = ssd_network.SSDNet_512(ssd_params)
